	...
	public static void main(String[] args)
	{
		/*
		 	...
		 	1) Scrivere un programma che chieda all'utente di inserire dei numeri: quando l'uente scrive 0, 
		 		...
		 		(usate gli arraylist!!)
		 	2) Leggere da un file una serie di nomi, salvarli in un AL e poi: stampare il nome pi� lungo,
		 		il nome con pi� vocali presenti, cancellare tutti i nomi che iniziano per G 
		 	3) Riempire un AL con numeri generati casualmente tra 1 e 10 compresi finch� la loro somma non supera 40,
...
//				nomeMax += ", " + s;
		String nomeMax = nomiMax(nomi);
 		...
 		//il nome con pi� vocali presenti
		...
		// O
		System.out.println("\nNomi pi� lunghi: " + nomeMax);
		System.out.println("\nNomi con pi� vocali: " + nomeVocaliMax);
